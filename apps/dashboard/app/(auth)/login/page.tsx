    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-zinc-400 mt-2 text-sm">Sign in to your dashboard</p>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/80 backdrop-blur-xl p-6 shadow-2xl shadow-black/50 space-y-6">
          ...
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full h-10 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-medium rounded-lg transition-all shadow-lg shadow-blue-600/25"
            >
              Sign in
            </button>
          </form>
