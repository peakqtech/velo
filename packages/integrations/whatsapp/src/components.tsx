 ...
 * Renders a green WhatsApp button fixed to a corner of the screen.
 */
export function WhatsAppWidget({
  ...
  const handleClick = () => {
    const finalMessage = isOnline ? message : offlineMessage;
...
/**
 * Inline WhatsApp button for embedding in page content.
 */
