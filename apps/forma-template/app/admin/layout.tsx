...
const navItems = [
  ...
  { href: "/admin/projects", label: "Projects", icon: "M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M18 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75z" },
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex">
      <aside className="w-64 bg-zinc-900 border-r border-zinc-800 flex flex-col shrink-0">
        <div className="p-6 border-b border-zinc-800">
          <Link href="/admin" className="text-lg font-semibold tracking-tight">FORMA Admin</Link>
